...
function toElements(children, _ref3) {
  ...
  var root = toh(React.createElement, {
    ...
    children: children.reduce(function (lines, child) {
      ...
      if (hasNewLine(child)) {
        var splitted = afterNewLine(child);
        console.log(splitted);
        lines.push({
          type: "element",
          tagName: "span",
          children: splitted[0] ? [splitted[0]] : [],
          properties: {
            className: "code-line"
          }
        });
        splitted.slice(1).forEach(function (l) {
          lines.push({
            type: "element",
            tagName: "span",
            children: [l],
...
function afterNewLine(node) {
  ...
  if (node.type === "text" && node.value.includes(sign)) {
    var fragments = node.value.split(sign).slice(1);
...
/******/ });
//# sourceMappingURL=client.ca17e0fad15a76429515.js.map