...
function Code(props) {
  ...
  var ranges = highlights.reduce(function (r, highlight, index) {
    var previous = r[index - 1];
    console.log(previous ? [previous.start + previous.length, highlight] : '');

    if (!previous || previous.start + previous.length !== highlight - 1) {
  ...
  console.log(ranges);
  return props.block ? React.createElement(StyledPre, null, code, highlights.length > 0 && React.createElement(StyledLines, null, highlights.map(function (highlight) {
...
})(["background:", ";height:1em;position:absolute;width:100%;height:1.5em;top:", "em;"], function (props) {
  return props.theme.name === 'dark' ? 'rgba(0, 0, 0, .5)' : 'rgba(0, 0, 0, .075)';
}, function (props) {
  return props.line * 1.5 + 0.5;
});
...
/******/ });
//# sourceMappingURL=client.de53aacf4a89596cc6e5.js.map