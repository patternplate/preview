...
})(["background:", ";position:absolute;width:100%;height:", "px;top:", "px;"], function (props) {
  return props.theme.name === 'dark' ? 'rgba(0, 0, 0, .5)' : 'rgba(0, 0, 0, .075)';
}, function (props) {
  return props.length * props.height * 1.275;
}, function (props) {
  return props.start * props.height * 1.275;
});
...
/******/ });
//# sourceMappingURL=client.bf46701be7b0255f9d0d.js.map