...
})(["background:", ";position:absolute;width:100%;margin:-.2em 0;height:", "em;top:", "em;"], function (props) {
  return props.theme.name === 'dark' ? 'rgba(0, 0, 0, .5)' : 'rgba(0, 0, 0, .075)';
}, function (props) {
  return props.length * 1.5 + 0.2;
}, function (props) {
...
/******/ });
//# sourceMappingURL=client.7264db88fc9af2958f84.js.map