...
function Code(props) {
  ...
  return props.block ? React.createElement(StyledPre, null, React.createElement(StyledCode, {
    ...
    }, line || React.createElement("span", null, " "));
      ...
      return React.createElement(StyledMarkdown, {
        ...
        remarkReactComponents: {
          ...
          pre: function pre(preProps) {
            var _ref = preProps.children || [],
                _ref2 = _slicedToArray(_ref, 1),
                _ref2$ = _ref2[0],
                child = _ref2$ === void 0 ? {} : _ref2$;
...
})(["& table{text-align:left;display:block;width:100%;overflow:auto;margin:0 0 16px 0;border-spacing:0;border-collapse:collapse;font-size:18px;line-height:24px;font-family:-apple-system,BlinkMacSystemFont,\"Segoe UI\",Helvetica,Arial,sans-serif,\"Apple Color Emoji\",\"Segoe UI Emoji\",\"Segoe UI Symbol\";}& tr{color:", ";border-top:1px solid ", ";background:transparent;}& tbody tr:nth-child(odd){background:", ";}& th{font-weight:600;}& th,& td{padding:20px 16px;border:1px solid ", ";vertical-align:top;}"], function (props) {
  return props.theme.colors.color;
}, function (props) {
  return props.theme.colors.border;
}, function (props) {
...
function getLanguagePayload(_ref4) {
...
var StyledMarkdownCodeBlock = styled.div.withConfig({
  displayName: "markdown-code-block__StyledMarkdownCodeBlock"
})(["border-radius:3px;font-size:15.3px;line-height:23px;padding:0 16px;margin-bottom:16px;background:", ";overflow:hidden;"], function (props) {
  return props.theme.colors.backgroundSecondary;
});

function MarkdownCodeBlock(props) {
  var code = textContent(props.children);
  return React.createElement(StyledMarkdownCodeBlock, null, React.createElement(Code, {
    block: true,
...
/******/ });
//# sourceMappingURL=client.2050342fa569279bc4b7.js.map