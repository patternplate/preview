...
})(["& table{text-align:left;display:block;width:100%;overflow:auto;margin:0 0 16px 0;border-spacing:0;border-collapse:collapse;font-size:18px;line-height:24px;font-family:-apple-system,BlinkMacSystemFont,\"Segoe UI\",Helvetica,Arial,sans-serif,\"Apple Color Emoji\",\"Segoe UI Emoji\",\"Segoe UI Symbol\";}& tr{color:", ";border-top:1px solid ", ";background:transparent;}& tr:nth-child(2n){background:", ";}& th{font-weight:600;}& th,& td{padding:20px 16px;border:1px solid ", ";vertical-align:top;}"], function (props) {
  return props.theme.colors.color;
}, function (props) {
  return props.theme.colors.border;
}, function (props) {
...
/******/ });
//# sourceMappingURL=client.3e051bd59cc217a280f6.js.map