...
})(["background:", ";position:absolute;width:100%;height:", "px;top:", "em;"], function (props) {
  return props.theme.name === 'dark' ? 'rgba(0, 0, 0, .5)' : 'rgba(0, 0, 0, .075)';
}, function (props) {
  return props.length * props.height;
}, function (props) {
  return props.start * props.height + 0.5;
});
...
/******/ });
//# sourceMappingURL=client.3b2445b5bb526ddeb23b.js.map