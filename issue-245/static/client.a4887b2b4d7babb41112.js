...
function toElements(children, _ref3) {
  ...
  var root = toh(React.createElement, {
    ...
    children: children.reduce(function (lines, child) {
      ...
      if (hasNewLine(child)) {
        var _afterNewLine = afterNewLine(_child),
            _afterNewLine2 = _slicedToArray(_afterNewLine, 2),
            _child = _afterNewLine2[0],
            addLines = _afterNewLine2[1];
...
function afterNewLine(node) {
  ...
  if (node.type === "text" && node.value.includes(sign)) {
    var fragments = node.value.split(sign);
    fragments.shift();
  ...
  return (node.children || []).reduce(function (after, child) {
    return afterNewLine(child, sign, after);
  }, seed);
...
/******/ });
//# sourceMappingURL=client.a4887b2b4d7babb41112.js.map