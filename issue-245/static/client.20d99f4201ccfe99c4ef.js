...
})(["background:", ";position:absolute;width:100%;margin:-.25em 0;height:", "em;top:", "em;"], function (props) {
  return props.theme.name === 'dark' ? 'rgba(0, 0, 0, .5)' : 'rgba(0, 0, 0, .075)';
}, function (props) {
  return props.length * 1.5 + 0.5;
}, function (props) {
...
/******/ });
//# sourceMappingURL=client.20d99f4201ccfe99c4ef.js.map