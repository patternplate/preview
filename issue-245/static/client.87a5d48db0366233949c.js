...
})(["border-radius:3px;font-size:15.3px;line-height:23px;padding:16px;margin-bottom:16px;background:", ";overflow:hidden;"], function (props) {
  return props.theme.colors.backgroundSecondary;
});
var StyledCode = styled(Code).withConfig({
  displayName: "markdown-code-block__StyledCode"
})(["margin:0;padding:0;"]);

function MarkdownCodeBlock(props) {
  var code = textContent(props.children);
  return React.createElement(StyledMarkdownCodeBlock, null, React.createElement(StyledCode, {
    block: true,
...
/******/ });
//# sourceMappingURL=client.87a5d48db0366233949c.js.map