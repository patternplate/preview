...
})(["& table{text-align:left;display:block;width:100%;overflow:auto;margin:0 0 16px 0;border-spacing:0;border-collapse:collapse;font-size:18px;font-family:-apple-system,BlinkMacSystemFont,\"Segoe UI\",Helvetica,Arial,sans-serif,\"Apple Color Emoji\",\"Segoe UI Emoji\",\"Segoe UI Symbol\";}& tr{color:", ";border-top:1px solid ", ";background:transparent;}& tr:nth-child(2n){background:", ";}& th{font-weight:600;}& th,& td{padding:6px 13px;border:1px solid ", ";vertical-align:top;}"], function (props) {
  return props.theme.colors.color;
}, function (props) {
  return props.theme.colors.border;
}, function (props) {
...
/******/ });
//# sourceMappingURL=client.f3c6dedfea17b7db8e04.js.map