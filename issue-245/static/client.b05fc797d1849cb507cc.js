...
function Code(props) {
  ...
  return props.block ? React.createElement(StyledPre, null, React.createElement(StyledCode, {
    className: props.className
  }, source), highlights.length > 0 && React.createElement(StyledLines, {
    position: "absolute"
...
var StyledLines = StyledCode.extend(_templateObject);
...
var rangeParser = __webpack_require__(/*! parse-numeric-range */ "../../node_modules/parse-numeric-range/index.js");
      ...
      return React.createElement(StyledMarkdown, {
        ...
        remarkReactComponents: {
          ...
          pre: function pre(preProps) {
            var language = getLanguages(preProps)[0];
            var highlights = getHighlights(preProps)[0];
            ...
            switch (language) {
              ...
              default:
                return React.createElement(MarkdownCodeBlock, _extends({}, preProps, {
                  language: language,
...
function getLanguagePayload(_ref2) {
...
function getLanguages(_ref3) {
  var children = _ref3.children;
  var payload = getLanguagePayload({
    children: children
  }).map(function (n) {
...
function getHighlights(_ref4) {
  var children = _ref4.children;
  return getLanguagePayload({
    children: children
  }).map(function (n) {
    return n.match(/\{([\d\-,\s]*)\}$/, "");
  }).map(function (n) {
...
/******/ });
//# sourceMappingURL=client.b05fc797d1849cb507cc.js.map